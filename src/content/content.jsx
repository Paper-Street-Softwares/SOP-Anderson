...
export const infos = {
  name: ' Dr. Anderson Sampaio',
  email: 'contato', // Email desejado pelo cliente
  emailSecundario: 'advogado@andersonsampaio.com', // Email desejado pelo cliente
  domain: 'andersonsampaio.com', // Sem "www"
  phone: {
    ddd: '21',
    firstPart: '97446', // Apenas os 5 primeiros números (incluindo o 9)
    secondPart: '2267', // Apenas os 4 últimos números
  },
  phoneSecundario: {
    ddd: 'A_Definir',
  ...
  instagramProfile: 'asampaio.adv', // Sem o @
  facebookProfile: '',
  linkeDinProfile: '',
  x: '',
  tiktokProfile: '',
...
const content = {
  texts: {
    navbar: {
      ...
      menuId: ['', 'feature', 'about'],
      ariaLabel: 'Botão de Contato',
      ctaButtonText: 'Contato',
      ctaButtonTextResponsive: 'Contato',
    },
    hero: {
      miniTag: 'ADVOGADO CÍVEL & TRABALHISTA',
      FirstPartTitle: 'Precisando de',
      DestaquePartTitle: (
        <p>
          <span className="italic relative inline-block">advogado</span>
        </p>
      ),
      SecondPartTitle: 'cível ou trabalhista?',
      subtitle: (
        <p>
          Dr. Anderson Sampaio atua com ética e experiência na defesa de pessoas
          e empresas.
        </p>
      ),
      ...
      ctaButtonText: 'Falar com o Dr. Anderson',
      ctaButtonTextSecondary: 'A_Definir',
      obsHero: {
        icon: <LucideIdCard />,
        iconTwo: <LucideIdCard />,
        text: 'Atendimento online para todo Brasil ou presencial para no Rio de Janeiro',
        textTwo: '',
      },
    ...
    features: {
      ...
      title: (
        <h1>
          ...
          <span className="destaque italic font-light">
            {' '}
            Direito Cível e Trabalhista
          </span>
        </h1>
      ),
      subtitle:
        'Atendimento estratégico e personalizado para proteger seus direitos e evitar prejuízos.',
      ...
      cards: {
        card1: {
          title: 'Consultoria e Assessoria Jurídica Cível',
          subtitle:
            'Orientação preventiva para evitar conflitos e prejuízos legais.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card2: {
          ...
          subtitle: 'Contratos claros e seguros para proteger seus interesses.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card3: {
          title: 'Ações de Família e Sucessões',
          subtitle: 'Atuação em divórcio, pensão, inventário e herança.',
          description: (
            <div>
              A_Definir <br />
              <br />
        ...
        card4: {
          title: 'Reclamações Trabalhistas (Empregado)',
          subtitle: 'Defesa dos direitos do trabalhador na Justiça.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card5: {
          title: <p>Defesa em Processos Trabalhistas (Empregador)</p>,
          subtitle: 'Proteção jurídica para empresas em ações trabalhistas.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card6: {
          title: 'Consultoria Trabalhista e Compliance',
          subtitle:
            'Segurança legal para sua empresa cumprir a lei e evitar riscos.',
          description: (
            <div>
              A_Definir
              <br />
    ...
    about: {
      ...
      miniTag: 'QUEM É O DR. ANDERSON SAMPAIO',
      ...
      SecondPartTitle: '',
      subtitle:
        'Da aprovação na OAB à advocacia sólida construída do zero, com experiência real.',
      paragraph: (
        <div>
          Iniciei minha trajetória na advocacia em 2015, após ser aprovado na
